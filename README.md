...
| Поле             | Значение                                |
|------------------|-----------------------------------------|
| ФИО              | [Ваисов Шерзодбек]                           |
| Группа           | [РПО-2]                       |
| Дисциплина       | Git и GitHub                            |
| Дата выполнения  | [03.08.2007]                            |
...
Я изучил git и закрепил практикой:push,merge,pullи fetch.Открыл для себя удобное расширение Git graph - оно помошает наглядно и понятнее за историей изменений.Научился (в оснавном на предыдущих занятиях) разрешать конфликты в git. Чуть трудно было но поотом понял как делать и сделал
